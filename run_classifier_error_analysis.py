...
def main(_):
  ...
  file_based_convert_examples_to_features(
      eval_examples, label_list, FLAGS.max_seq_length, tokenizer, error_analysis_file)
  ...
  error_analysis_input_fn = file_based_input_fn_builder(
  ...
  checkpoint_step = -1
  file_list = os.listdir(FLAGS.output_dir)
